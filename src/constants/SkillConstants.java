...
public class SkillConstants {
    ...
    public class Beginner {
       ...
       public static final short BLESSING_OF_THE_FAIRY = 12, 
                FOLLOW_THE_LEADER = 8, 
                RECOVERY = 1001, 
                NIMBLE_FEET = 1002, 
                MONSTER_RIDER = 1004, 
                ...
                NIGHTMARE = 1049, 
                YETI = 1050, 
                PINK_BEAR_HOT_AIR_BALLOON = 1052, 
                TRANSFORMATION_ROBOT = 1053, 
                MOTORCYCLE = 1063, 
                POWER_SUIT = 1064, 
                LEONARDO_THE_LION =1072, 
                SMALL_RABBIT = 1101, 
                ROGUE_RABBIT = 1096,   
                WITCH_BROOMSTICK = 1081, 
                NIMBUS_CLOUD = 1030, 
                CHARGE_WOODEN_PONY = 1025, 
                BLACK_SCOOTER = 1028, 
                PINK_SCOOTER = 1029, 
                GARGOYLE = 1040, 
                SPACESHIP = 1046, 
    ...
    public class Swordsman {
        ...
        public static final int IMPROVED_MAX_HP_INCREASE = 1000006,
                IRON_BODY = 1000003;
    }
    ...
    public class Corsair {
        ...
        public static final int MAPLE_WARRIOR = 5221000,
                ...
                RAPID_FIRE = 5221004,
                BATTLE_SHIP = 5221006,
                BATTLE_SHIP_CANNON = 5221007,
                BATTLE_SHIP_TORPEDO = 5221008,
                HYPNOTIZE = 5221009,
    ...
    public class Noblesse {
       ...
       public static final int BLESSING_OF_THE_FAIRY = 10000012, 
                ...
                BERSERK_FURY = 10001011, 
                SPACE_DASH = 1001015, 
                YETI_MOUNT1 = 10001019, 
                YETI_MOUNT2 = 10001022, 
                WITCH_BROOMSTICK = 10001081, 
                ...
                OSTRICH = 10001051, 
                CROCO = 10001027, 
                OS4_SHUTTLE = 10001065, 
                OWL = 10001069, 
                MOTHERSHIP =10001070, 
                OS3A_MACHINE = 10001071, 
                RACE_KART = 10001033, 
                ZD_TIGER = 10001034, 
                MIST_BALROG = 10001035, 
                SHINJO = 10001042, 
                ORANGE_MUSHROOM = 10001044, 
                NIGHTMARE = 10001049, 
                YETI = 10001050, 
                PINK_BEAR_HOT_AIR_BALLOON = 10001052, 
                TRANSFORMATION_ROBOT = 10001053, 
                MOTORCYCLE = 10001063, 
                POWER_SUIT = 10001064, 
                SMALL_RABBIT = 10001101, 
                ROGUE_RABBIT = 10001096, 
                LEONARDO_THE_LION =10001072, 
                NIMBUS_CLOUD = 10001030, 
                CHARGE_WOODEN_PONY = 1001025, 
                BLACK_SCOOTER = 10001028, 
                PINK_SCOOTER = 10001029, 
                GARGOYLE = 10001040, 
                SPACESHIP = 10001046, 
                UNICORN = 10001037, 
                RED_TRUCK = 10001039, 
    ...
    public class Legend {
       ...
       public static final int THREE_SNAILS = 20001000, 
                ...
                TUTORIAL_SKILL4 = 20000017, 
                TUTORIAL_SKILL5 = 20000018, 
                YETI_MOUNT1 = 20001019, 
                YETI_MOUNT2 = 20001022, 
                WITCH_BROOMSTICK = 20001081, 
                ...
                OSTRICH = 20001051, 
                CROCO = 20001027, 
                OS4_SHUTTLE = 20001065, 
                OWL = 20001069, 
                MOTHERSHIP =20001070, 
                OS3A_MACHINE = 20001071, 
                RACE_KART = 20001033, 
                ZD_TIGER = 20001034, 
                MIST_BALROG = 20001035, 
                SHINJO = 20001042, 
                ORANGE_MUSHROOM = 20001044, 
                NIGHTMARE = 20001049, 
                YETI = 20001050, 
                PINK_BEAR_HOT_AIR_BALLOON = 20001052, 
                TRANSFORMATION_ROBOT = 20001053, 
                MOTORCYCLE = 20001063, 
                POWER_SUIT = 20001064, 
                SMALL_RABBIT = 20001101, 
                ROGUE_RABBIT = 20001096, 
                LEONARDO_THE_LION =20001072, 
                NIMBUS_CLOUD = 20001030, 
                CHARGE_WOODEN_PONY = 20001025, 
                BLACK_SCOOTER = 20001028, 
                PINK_SCOOTER = 20001029, 
                GARGOYLE = 20001040, 
                SPACESHIP = 20001046, 
                UNICORN = 20001037, 
                RED_TRUCK = 20001039, 
    ...
    public class BladeMaster {
        ...
        public static final int VENOM = 4340001,
                MAPLE_WARRIOR = 4341000,
                FINAL_CUT = 4341002,
                MONSTER_BOMB = 4341003,
                SUDDEN_RAID = 4341004,
                CHAINS_OF_HELL = 4341005,
                MIRRORED_TARGET = 4341006,
                THORNS = 4341007,
                HEROS_WILL = 4341008;
    }
    ...
    public class Citizen {
        ...
        public static final int POTION_MASTERY = 30000002, 
                ...
                OSTRICH = 30001051, 
                CROCO = 30001027, 
                OS4_SHUTTLE = 30001065, 
                OWL = 30001069, 
                MOTHERSHIP =30001070, 
                OS3A_MACHINE = 30001071, 
                RACE_KART = 30001033, 
                ZD_TIGER = 30001034, 
                MIST_BALROG = 30001035, 
                SHINJO = 30001042, 
                ORANGE_MUSHROOM = 30001044, 
                NIGHTMARE = 30001049, 
                YETI = 30001050, 
                PINK_BEAR_HOT_AIR_BALLOON = 30001052, 
                TRANSFORMATION_ROBOT = 30001053, 
                MOTORCYCLE = 30001063, 
                POWER_SUIT = 30001064, 
                SMALL_RABBIT = 30001101, 
                ROGUE_RABBIT = 30001096, 
                LEONARDO_THE_LION =30001072, 
                NIMBUS_CLOUD = 30001030, 
                CHARGE_WOODEN_PONY = 30001025, 
                BLACK_SCOOTER = 30001028, 
                PINK_SCOOTER = 30001029, 
                GARGOYLE = 30001040, 
                SPACESHIP = 30001046, 
                UNICORN = 30001037, 
                RED_TRUCK = 30001039, 
    ...
    public class BattleMage {
        ...
        public static final int TRIPLE_BLOW = 32001000,
                ...
                BODY_BOOST_DARK_AURA = 32110007,
                BODY_BOOST_YELLOW_AURA = 32110008,
                BODY_BOOST_BLUE_AURA = 32110009,
    ...
    public class WildHunter {
        ...
        public static final int TRIPLE_SHOT = 33001000,
                ...
                ITS_RAINING_MINES = 33101004,
                JAGUAR_OSHI = 33101005,
                FINAL_ATTACK = 33101009,
    ...
    public class Mechanic {
        ...
        public static final int FLAME_LAUNCHER = 35001001,
                ...
                GIANT_ROBOT = 35121003,
                BOTS_N_TOTS = 35121009,
                AMPLIFIER = 35121010,
                PARTY_SHIELD = 35121011,
                ROBOT_MASTERY = 35120001,
                MAPLE_WARRIOR = 35121007,
                HEROS_WILL = 35121008,
                SIEGE_MODE2 = 35121013;
    }
