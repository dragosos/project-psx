...
public final class AdminCommandHandler extends AbstractMaplePacketHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        if (!c.getPlayer().isGM() || !c.getPlayer().isMWLB()) {
            return;
        }
        ...
        switch (mode) {
            ...
            case 0x12: // Send
                ...
                c.getChannelServer().getPlayerStorage().getCharacterByName(victim).changeMap(c.getChannelServer().getMapFactory(c.getPlayer().getGMode()).getMap(mapId));
                break;
            case 0x15: // Kill
