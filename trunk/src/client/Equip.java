...
public class Equip extends Item implements IEquip {
    ...
    public byte potential, stars;
    public short potential1, potential2, potential3;
    ...
    @Override
    public short getPotentialStats(int type){
        switch(type){
            case 1:
                return potential1;
            case 2:
    ...
    @Override
    public byte isPotentialByte(){
        return potential;
    }
    
    @Override
    public byte getStarsByte(){
        if(potential == (byte)0){
            return 0;
        } else {
            return stars;
