 ...
 * @pos : 212, 215
 */
public class ScarlionFight extends PartyQuest {
    public ScarlionFight(MapleCharacter leader, byte channel) {
        super(leader, channel, (10 * 60), 910000000, 910000000, new int[] {180000001}, (byte) 2, (byte) 100, (short) 255, PartyQuestType.SCARLION);
        scheduleThread(new startSpawns(), 1000 * 60);
        modifyClock(10);
        PQMessage("Hurry up! Scarlion will spawn in 10 seconds.");
    }
    ...
    public void finish() {
        try {
            ...
            modifyClock(15);
            PQMessage("Congratulations! You have defeated Scarlion. Please loot your bounty quickly, you will be warped out in 15 seconds.");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
